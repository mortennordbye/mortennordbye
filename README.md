...
With extensive hands-on experience in managing enterprise-grade infrastructure, I specialize in Azure and Kubernetes platforms within regulated industries. My core focus lies in Infrastructure as Code (Terraform), GitOps, and building secure, observable systems. This specialized skill set enables me to confidently navigate complex technical landscapes and provide comprehensive, compliant solutions.

In addition to my professional pursuits, I am a dedicated Homelab enthusiast. I run a hybrid environment on my own hardware (and public clouds) to experiment with the latest cloud-native tooling, automation stacks, and monitoring solutions. I am dedicated to staying updated with the latest industry trends by "learning in public," documenting my configurations and experiments in my repositories.

## Cloud Engineer at Orange Business

In my role as a Cloud Engineer at Orange Business, I implement enterprise-grade Azure infrastructure across various customer environments. I use Terraform and automated CI/CD pipelines to deploy secure environments and manage production-ready infrastructure.

I have extensive experience operating AKS and cloud-native platforms, utilizing ArgoCD for GitOps workflows. My background includes using Helm and Kustomize for application delivery, alongside the management of platform components such as Traefik, External Secrets Operator, cert-manager, Prometheus, and OpenTelemetry.

My Azure-specific experience covers networking and connectivity, including Virtual WAN (vWAN), ExpressRoute, Private Link, and DNS, as well as Front Door and WAF for traffic management. For observability, I have experience working with Azure Monitor, Managed Grafana, Log Analytics Workspaces, and Azure Monitor Workspaces.
